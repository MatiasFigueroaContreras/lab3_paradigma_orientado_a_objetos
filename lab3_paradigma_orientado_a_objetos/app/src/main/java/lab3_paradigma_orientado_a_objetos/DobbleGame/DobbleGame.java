...
public class DobbleGame implements IDobbleGame{
    ...
    */
    ...
    /**
    * <p> dado un String señalando el modo, se crea este objeto Mode, si es que
    ...
    */
    ...
    protected void addCardsInPlayCurrentPlayerTurn(){
    ...
    */  
    protected void addCardsInPlayPlayer(String name){
    ...
    */    
    protected void addScoreCurrentPlayerTurn(int score){
    ...
    */   
    protected void addScorePlayer(int score, String name){
    ...
    */
    protected void addDobbleCardsInPlay(int start, int end){
    ...
    * </p>
    */
    protected void backCardsInPlay(){
    ...
    * </p>
    */
    protected void clearCardsInPlay(){
    ...
    */
    protected int elementOccurrencesCardsInPlay(String element){
    ...
    */
    protected String nthElement(int n){
    ...
    */
    protected int numDobbleCards(){
        return this.gameArea.numDobbleCards();
    }
    
    /**
    * <p> Añade un jugador al controlador de estos, teniendo en cuenta los
    ...
    */
    ...
    /**
    * <p> Añade un jugador extra al controlador de estos, este metodo esta
