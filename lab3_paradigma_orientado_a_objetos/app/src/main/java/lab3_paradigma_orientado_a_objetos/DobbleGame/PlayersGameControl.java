...
public class PlayersGameControl {
    ...
    */  
    ...
    /**
    * <p> Añade un jugador al arreglo (this.players), respetando que este no 
    *       sea parte de este, que no se supere el maximo de jugadores a 
    *       registrar más espacios reservados, y que no contenga el nombre 
    *       reservado CPU.
    * </p>
    ...
    */
    ...
    /**
    * <p> Obtiene el puntaje más alto entre los jugadores.
    * </p>
